    ...
    try:
        while True:
            ...
            try:
                ...
                if data["type"] == "bytes":
                    # Mock face detection (for testing without OpenCV/MediaPipe)
                    import random
                    face_detected = random.random() > 0.7  # 30% chance of face detection
                    face_count = random.randint(1, 2) if face_detected else 0
