...
class FaceDetector:
    ...
    def detect_faces(self, frame: np.ndarray) -> Tuple[bool, np.ndarray, int]:
        """
        ...
        Returns:
            Tuple of (face_detected, annotated_frame, face_count)
        """
        ...
        return face_detected, frame, face_count
...
class VideoRecorder:
    ...
    def start_recording(self, frame_shape: Tuple[int, int, int]) -> None:
        """
        Start a new recording.
        
        Args:
            frame_shape: Tuple of (height, width, channels) for the video frames
        """
    ...
    def stop_recording(self) -> Optional[str]:
        ...
        if self.current_file is not None:
            result = str(self.current_file.relative_to(self.output_dir))
